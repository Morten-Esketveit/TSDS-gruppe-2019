...
\end{figure}
As the figure shows, the removal of a relatively small number of hubs can dramatically alter network characteristics. The network is thus somewhat vulnerable to 'attacks' on the most connected airports. \\ 
