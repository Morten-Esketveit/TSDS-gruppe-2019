...
In order to get a sense of correlation structure, we show all the continuous variables in the correlation plot in figure \ref{fig:correl}. Unsurprisingly, we see that prices are positively correlated with distance and flight duration and negatively with the number of flights on the route. We see that the rest of the variables, including all our network variables, are only weakly correlated with prices. It is further seen that some of the features exhibits more or less multicolinearity.
...
\begin{table}[htbp]
  ...
  \caption{Results, Prediction Model}
    ...
    \multicolumn{1}{l}{Model evaluation} & $R^2$  & \multicolumn{1}{r}{0.411} & \multicolumn{1}{r}{0.430} & \multicolumn{1}{r}{0.413} & \multicolumn{1}{r}{0.433} \\
          &       & \multicolumn{1}{r}{0.030} &       &       & \multicolumn{1}{r}{(0.030)} \\
