...
\end{figure}
As the figure shows, the network characteristics change dramatically when a few hubs are removed. The network is thus somewhat vulnerable to 'attacks' on the most connected airports. \\ 
